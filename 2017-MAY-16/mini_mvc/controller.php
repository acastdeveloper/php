...
//MÈTODE CENTRAL "fontcroller" que rep les peticions
//La gràcia del controller és l'renrutament i
//aplica el patró Front Controller.
//
...
function enviar_data() {
	...
	if($vista) {
		//Saber quin model ha de mostrar
		$modelo = identificar_modelo($vista);
		if($modelo) {
			$data = invocar_modelo($modelo);
			//Instanciar el model corresponent
			if($data) {
